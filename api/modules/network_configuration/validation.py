...
from modules.network_configuration.models import  NetworkConfigurationSet
from modules.users.models import AdministratorExtended
from modules.users.permissions import has_permissions


def validate_machines_in_network_configuration(network_configuration: NetworkConfigurationSet, logged_in_user: AdministratorExtended):
    ...
    for intnet in network_configuration.internal_networks.values():
        if intnet.machines is not None:
